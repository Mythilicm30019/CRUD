...
$StudentRegisterData     = "SELECT * FROM student_register ORDER BY student_id ASC";
...
if (isset($_POST['btn_delete']) && $_POST['btn_delete'] === "Delete") {
	$id    = intval($_POST['id']);
    $query = "UPDATE student_register SET active = 0 WHERE student_id = $id"; // soft delete

    if (pg_query($query)) {
        $msg ="Student Details Deleted Successfully";
		echo $msg;
    } else {
        $msg ="Student Details not deleted, please try again...!!";
    }
...
if (isset($_POST['btn_undodelete']) && $_POST['btn_undodelete'] === "UndoDelete") {
	$id    = intval($_POST['id']);
    $query = "UPDATE student_register SET active = 1 WHERE student_id = $id"; // soft delete
    if (pg_query($query)) {
        $msg ="Student Details Activated Successfully";
		echo $msg;
    } else {
        $msg ="Student Details not activated, please try again...!!";
    }
    exit; 
}
?>
...
<script type="text/javascript">
	...
	function goBack(){
	 ...
	 function RedirectToEdit(EditId) {
        var url = "StudentRegister.php?action=EDIT&id=" + EditId;
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form" id="form1">
            ...
            <!--==============================Content=================================-->
			<div class="content">
				<div class="title">Student Register  View & Edit</div>
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">&nbsp;Student Register - View</div>
                                                            	...
                                                            	<table id="example" class="display rtable mgtb-8" style="width:100%">
                                                                    <thead>
									                                	<tr class="note heading">
                                                                            ...
                                                                            <th class="colhead" style="text-align:center">Student Age</th>
                                                                    ...
                                                                    <tbody>
								                                		...
								                                		<tr>
								                                			...
								                                			<td align="left"><?php echo $value['student_first_name'] ?></td>
								                                			<td align="left"><?php echo $value['student_second_name'] ?></td>
                                                                            <td align="left"><?php echo $value['student_age'] ?></td>
                                                                            ...
                                                                            if($value['active'] == 1){ ?>
								                                				<td align="center" style="width:100px">
                                                                                    <!-- <a data-url="CementGradeType?id=<?php echo $value['student_id']; ?>" class=" BtnHref btn btn-info" name="btn_edit" id="btn_edit">
																						Edit
																					</a> -->
																					<a  onclick="RedirectToEdit(<?php echo $value['student_id']; ?>);" class=" BtnHref btn btn-info" name="btn_edit" id="btn_edit">
																						Edit
																					</a>
                                                                            <?php }
                                                                            else{ ?>								                                				
