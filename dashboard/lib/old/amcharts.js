(function () {
  var d;
  window.AmCharts ? d = window.AmCharts : (d = {}, window.AmCharts = d, d.themes = {}, d.maps = {}, d.inheriting = {}, d.charts = [], d.onReadyArray = [], d.useUTC = false, d.updateRate = 60, d.uid = 0, d.lang = {}, d.translations = {}, d.mapTranslations = {}, d.windows = {}, d.initHandlers = [], d.amString = "am", d.pmString = "pm");
  d.Class = function (a) {
    var b = function () {
  ...
  d.addChart = function (a) {
    window.requestAnimationFrame ? d.animationRequested || (d.animationRequested = true, window.requestAnimationFrame(d.update)) : d.updateInt || (d.updateInt = setInterval(function () {
      d.update();
  ...
  d.removeChart = function (a) {
    ...
    0 === b.length && (d.requestAnimation && (window.cancelAnimationFrame(d.requestAnimation), d.animationRequested = false), d.updateInt && (clearInterval(d.updateInt), d.updateInt = NaN));
  };
  d.isModern = true;
  ...
  9 > d.IEversion && 0 < d.IEversion && (d.isModern = false, d.isIE = true);
  d.dx = 0;
  d.dy = 0;
  if (document.addEventListener || window.opera) d.isNN = true, d.isIE = false, d.dx = 0.5, d.dy = 0.5;
  document.attachEvent && (d.isNN = false, d.isIE = true, d.isModern || (d.dx = 0, d.dy = 0));
  window.chrome && (d.chrome = true);
  ...
  d.addGlobalListeners = function () {
    d.globalListenersAdded || (d.globalListenersAdded = true, d.isNN && (document.addEventListener("mousemove", d.handleMouseMove), document.addEventListener("keyup", d.handleKeyUp), document.addEventListener("mouseup", d.handleMouseUp, true), window.addEventListener("load", d.handleLoad, true)), d.isIE && (document.attachEvent("onmousemove", d.handleMouseMove), document.attachEvent("onmouseup", d.handleMouseUp), window.attachEvent("onload", d.handleLoad)));
  };
  d.addGlobalListeners();
  d.addWheelListeners = function () {
    d.wheelIsListened || (d.isNN && (window.addEventListener("DOMMouseScroll", d.handleWheel, {passive: false, useCapture: true}), document.addEventListener("mousewheel", d.handleWheel, {passive: false, useCapture: true})), d.isIE && document.attachEvent("onmousewheel", d.handleWheel));
    d.wheelIsListened = true;
  };
  d.clear = function () {
    var a = d.charts;
    ...
    d.charts = [];
    d.isNN && (document.removeEventListener("mousemove", d.handleMouseMove, true), document.removeEventListener("keyup", d.handleKeyUp, true), document.removeEventListener("mouseup", d.handleMouseUp, true), window.removeEventListener("load", d.handleLoad, true), window.removeEventListener("DOMMouseScroll", d.handleWheel, true), document.removeEventListener("mousewheel", d.handleWheel, true));
    d.isIE && (document.detachEvent("onmousemove", d.handleMouseMove), document.detachEvent("onmouseup", d.handleMouseUp), window.detachEvent("onload", d.handleLoad));
    d.globalListenersAdded = false;
    d.wheelIsListened = false;
  };
  ...
  d.update = function () {
    ...
    d.updateCount++;
    var b = false;
    d.updateCount == d.validateAt && (b = true, d.updateCount = 0);
...
(function () {
  ...
  d.ifArray = function (a) {
    return a && "object" == typeof a && 0 < a.length ? true : false;
  };
  ...
  d.formatNumber = function (a, b, c, e, g) {
    ...
    h = 0 > a ? "-" : "";
    a = Math.abs(a);
    var k = String(a), l = false;
    -1 != k.indexOf("e") && (l = true);
  ...
  d.hitTest = function (a, b, c) {
    var e = false, g = a.x, f = a.x + a.width, h = a.y, k = a.y + a.height, l = d.isInRectangle;
    e || (e = l(g, h, b));
    e || (e = l(g, k, b));
    e || (e = l(f, h, b));
    e || (e = l(f, k, b));
    e || true === c || (e = d.hitTest(b, a, true));
    return e;
  };
  d.isInRectangle = function (a, b, c) {
    return a >= c.x - 5 && a <= c.x + c.width + 5 && b >= c.y - 5 && b <= c.y + c.height + 5 ? true : false;
  };
  d.isPercents = function (a) {
    if (-1 != String(a).indexOf("%")) return true;
  };
  ...
  d.addPrefix = function (a, b, c, e, g) {
    ...
    if (1 < a) for (k = b.length - 1; -1 < k; k--) {
      if (a >= b[k].number && (l = a / b[k].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l, m), m = d.formatNumber(c, {precision: -1, decimalSeparator: e.decimalSeparator, thousandsSeparator: e.thousandsSeparator}), !g || l == c)) {
        f = h + "" + m + "" + b[k].prefix;
        break;
      }
  ...
  d.isString = function (a) {
    return "string" == typeof a ? true : false;
  };
  ...
  d.processObject = function (a, b, c, e) {
    if (false === a instanceof b && (a = e ? d.extend(new b(c), a) : d.extend(a, new b(c), true), a.listeners)) for (var g in a.listeners) b = a.listeners[g], a.addListener(b.event, b.method);
    return a;
  };
  ...
  d.bounce = function (a, b, c, e, d) {
    return (b /= d) < 0.36363636363636365 ? 7.5625 * e * b * b + c : b < 0.7272727272727273 ? e * (7.5625 * (b -= 0.5454545454545454) * b + 0.75) + c : b < 0.9090909090909091 ? e * (7.5625 * (b -= 0.8181818181818182) * b + 0.9375) + c : e * (7.5625 * (b -= 0.9545454545454546) * b + 0.984375) + c;
  };
...
(function () {
  var d = window.AmCharts;
  d.AxisBase = d.Class({construct: function (a) {
    ...
    this.showLastLabel = this.showFirstLabel = true;
    this.fillColor = "#FFFFFF";
    this.fillAlpha = 0;
    this.labelsEnabled = true;
    this.labelRotation = 0;
    this.autoGridCount = true;
    this.offset = 0;
    this.guides = [];
    this.visible = true;
    this.counter = 0;
    this.guides = [];
    this.ignoreAxisWidth = this.inside = false;
    ...
    this.centerLabelOnFullPeriod = this.markPeriodChange = this.boldPeriodBeginning = true;
    this.titleWidth = 0;
    ...
    if (a) {
      ...
      var h = g.width, g = g.height, k = this.width, l = this.height, m = 0, n = a.getBBox().height / 2, q = this.inside, p = this.titleAlign;
    ...
    this.fire({type: c, value: b.value, serialDataItem: b.serialDataItem, axis: this, target: b.label, chart: this.chart, event: a});
  }, addGuide: function (a) {
    for (var b = this.guides, c = false, e = b.length, g = 0; g < b.length; g++) b[g] == a && (c = true, e = g);
    ...
    this.chart.showBalloon(a.balloonText, e, true, c, b);
    ...
    if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
      ...
      this.boldLabels && (l = true);
      m = new this.axisItemRenderer(this, g, f, false, n, I, false, l);
      this.pushAxisItem(m);
      m = l = p;
      if (!isNaN(w)) for (g = 1; g < u; g += w) this.gridAlpha = this.minorGridAlpha, f = p + x * g, f = d.resetDateToMin(new Date(f), A, w, t).getTime(), f = new this.axisItemRenderer(this, (f - this.startTime) * this.stepWidth, void 0, void 0, void 0, void 0, void 0, void 0, void 0, true), this.pushAxisItem(f);
      this.gridAlpha = z;
    }
    ...
    return "DD" == a && "hh" != g && c - b < d.getPeriodDuration(a, e) - d.getPeriodDuration("hh", 1) ? false : c != b ? true : false;
    ...
    if (this.balloon && void 0 !== e && this.balloon.enabled) {
      if (this.balloonTextFunction) {
        if ("date" == this.type || true === this.parseDates) e = new Date(e);
    ...
    b && (b = b.cursorPosition, "mouse" != b && (this.stickBalloonToCategory = true), "start" == b && (this.stickBalloonToStart = true), "ValueAxis" == this.cname && (this.stickBalloonToCategory = false));
    this.balloon && (this.balloon.destroy && this.balloon.destroy(), d.extend(this.balloon, a.balloon, true));
...
(function () {
  var d = window.AmCharts;
  d.ValueAxis = d.Class({inherits: d.AxisBase, construct: function (a) {
    ...
    this.includeAllValues = this.recalculateToPercents = this.includeHidden = this.includeGuidesInMinMax = this.integersOnly = false;
    ...
    true === this.dataChanged && (this.updateData(), this.dataChanged = false);
    "date" == c && (this.logarithmic = false, this.min = this.minRR, this.max = this.maxRR, this.reversed = false, this.getDateMinMax());
    if (this.logarithmic) {
    ...
    this.grid0 = null;
    var f, h, k = a.dx, l = a.dy, e = false, g = this.logarithmic;
    if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = true; else {
      ...
      if (this.logarithmic) {
        ...
        var r = Math.log(r) * Math.LOG10E - Math.log(h) * Math.LOG10E, w = Math.log(this.max) / Math.LN10 - Math.log(h) * Math.LOG10E;
      ...
      for (h = t; h < r; h += p) {
        ...
        -1 != String(A).indexOf("e") && (this.exponential = true);
      }
      ...
      if (this.autoGridCount || 0 !== this.gridCount) if ("date" == c) this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime = this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw(); else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), c = this.minCalc, g && (r++, c = this.maxCalc - r * x), this.gridCountReal = r, h = this.startCount = t; h < r; h += p) if (t = x * h + c, t = d.roundTo(t, this.maxDecCount + 1), !this.integersOnly || Math.round(t) == t) if (isNaN(w) || Number(d.toFixed(t, w)) == t) {
        ...
        if (!isNaN(y) && 0 < A && h < r - 1) {
          ...
          for (H = 1; H < f; H++) {
            var Q = this.getCoordinate(t + y * H), Q = new this.axisItemRenderer(this, Q, "", false, 0, 0, false, false, 0, true);
            this.pushAxisItem(Q);
          }
          this.gridAlpha = I;
        }
      ...
      this.baseCoord = this.getCoordinate(u, true);
    ...
    "100% stacked" == b && (b = "100%");
    this.stackType = b;
    var c = [], e = [], g = [], f = [], h, k = this.chart.graphs, l, m, n, q, p, t = this.baseValue, r = false;
    if ("line" == a || "step" == a || "smoothedLine" == a) r = true;
    ...
    for (c = 0; c < b.length; c++) {
      ...
      if (e.valueAxis == this) {
        ...
        if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
          var n = m.minDuration(), n = new Date(a.startTime + n / 2), q = d.resetDateToMin(new Date(a.startTime), m.minPeriod).getTime();
          d.resetDateToMin(new Date(n), m.minPeriod).getTime() > q && h++;
        }
        if (m = a.recalculateFromDate) m = d.getDate(m, a.dataDateFormat, "fff"), h = a.getClosestIndex(a.chartData, "time", m.getTime(), true, 0, a.chartData.length), k = a.chartData.length - 1;
    ...
    var a = false, b = this.chart, c = b.graphs, e;
    for (e = 0; e < c.length; e++) {
      var g = c[e].type;
      ("line" == g || "step" == g || "smoothedLine" == g) && this.expandMinMax && (a = true);
    }
    a && (0 < this.start && this.start--, this.end < this.data.length - 1 && this.end++);
    "serial" == b.type && (true !== b.categoryAxis.parseDates || a || this.end < this.data.length - 1 && this.end++);
    ...
    if (this.logarithmic) {
      ...
      var g = Math.log(g) * Math.LOG10E - Math.log(e) * Math.LOG10E, f = Math.log(b) / Math.LN10 - Math.log(e) * Math.LOG10E;
      this.relativeStart = d.roundTo((Math.log(a) / Math.LN10 - Math.log(e) * Math.LOG10E) / g, 9);
      this.relativeEnd = d.roundTo(f / g, 9);
    }
    if (this.minZoom != a || this.maxZoom != b) return this.minZoom = a, this.maxZoom = b, e = {type: "axisZoomed"}, e.chart = this.chart, e.valueAxis = this, e.startValue = a, e.endValue = b, e.relativeStart = this.relativeStart, e.relativeEnd = this.relativeEnd, this.prevStartValue == a && this.prevEndValue == b || this.fire(e), this.prevStartValue = a, this.prevEndValue = b, c || (a = {}, d.copyProperties(e, a), a.type = "axisIntZoomed", this.fire(a)), 0 === this.relativeStart && 1 == this.relativeEnd && (this.maxZoom = this.minZoom = NaN), true;
  }, coordinateToValue: function (a) {
    if (isNaN(a)) return NaN;
    var b = this.axisWidth, c = this.stepWidth, e = this.reversed, d = this.rotate, f = this.min, h = this.minReal;
    return true === this.logarithmic ? Math.pow(10, (d ? true === e ? (b - a) / c : a / c : true === e ? a / c : (b - a) / c) + Math.log(h) * Math.LOG10E) : true === e ? d ? f - (a - b) / c : a / c + f : d ? a / c + f : f - (a - b) / c;
  }, getCoordinate: function (a, b) {
    if (isNaN(a)) return NaN;
    var c = this.rotate, e = this.reversed, d = this.axisWidth, f = this.stepWidth, h = this.min, k = this.minReal;
    true === this.logarithmic ? (0 === a && (a = this.treatZeroAs), h = Math.log(a) * Math.LOG10E - Math.log(k) * Math.LOG10E, c = c ? true === e ? d - f * h : f * h : true === e ? f * h : d - f * h) : c = true === e ? c ? d - f * (a - h) : f * (a - h) : c ? f * (a - h) : d - f * (a - h);
...
(function () {
  var d = window.AmCharts;
  d.RecAxis = d.Class({construct: function (a) {
    var b = a.chart, c = a.axisThickness, e = a.axisColor, g = a.axisAlpha, f = a.offset, h = a.dx, k = a.dy, l = a.x, m = a.y, n = a.height, q = a.width, p = b.container;
...
(function () {
  var d = window.AmCharts;
  d.RecItem = d.Class({construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
    b = Math.round(b);
    var p = a.chart;
    this.value = c;
    void 0 == c && (c = "");
    ...
    h ? (void 0 !== h.id && (q = p.classNamePrefix + "-guide-" + h.id), P = true, isNaN(h.tickLength) || (B = h.tickLength), void 0 != h.lineColor && (I = h.lineColor), void 0 != h.color && (w = h.color), isNaN(h.lineAlpha) || (D = h.lineAlpha), isNaN(h.dashLength) || (H = h.dashLength), isNaN(h.lineThickness) || (C = h.lineThickness), true === h.inside && (J = true, 0 < ea && (ea = 0)), isNaN(h.labelRotation) || (n = h.labelRotation), isNaN(h.fontSize) || (r = h.fontSize), h.position && (Z = h.position), void 0 !== h.boldLabel && (k = h.boldLabel), isNaN(h.labelOffset) || (aa = h.labelOffset)) : "" === c && (B = 0);
    ...
    if ("H" == Pa) {
      ...
      ga = "end";
      if (true === J && "left" == Z || false === J && "right" == Z) ga = "start";
      v = b - Qa / 2 + 2;
    ...
    fa && (fa.translate(oa, Y), d.setCN(p, fa, a.bcn + "tick"), d.setCN(p, fa, q, true), h && d.setCN(p, fa, "guide"));
    false === a.visible && (fa && fa.remove(), ca && (ca.remove(), ca = null));
    ca && (ca.attr({"text-anchor": ga}), ca.translate(G, v, NaN, true), 0 !== n && ca.rotate(-n, a.chart.backgroundColor), a.allLabels.push(ca), this.label = ca, d.setCN(p, ca, a.bcn + "label"), d.setCN(p, ca, q, true), h && d.setCN(p, ca, "guide"));
    Ba && (d.setCN(p, Ba, a.bcn + "grid"), d.setCN(p, Ba, q, true), h && d.setCN(p, Ba, "guide"));
    Da && (d.setCN(p, Da, a.bcn + "fill"), d.setCN(p, Da, q, true));
...
(function () {
  var d = window.AmCharts;
  d.AmChart = d.Class({construct: function (a) {
    this.svgIcons = this.tapToActivate = true;
    this.theme = a;
    this.classNamePrefix = "amcharts";
    this.addClassNames = false;
    ...
    this.addCodeCredits = this.accessible = true;
    ...
    this.prefixesOfSmallNumbers = [{number: 1e-24, prefix: "y"}, {number: 1e-21, prefix: "z"}, {number: 1e-18, prefix: "a"}, {number: 1e-15, prefix: "f"}, {number: 1e-12, prefix: "p"}, {number: 1e-9, prefix: "n"}, {number: 0.000001, prefix: "µ"}, {number: 0.001, prefix: "m"}];
    this.panEventsEnabled = true;
    ...
    if (b = "object" != typeof a ? document.getElementById(a) : a) {
      ...
      this.amExport && d.AmExport && (this.AmExport = d.extend(this.amExport, new d.AmExport(this), true));
      ...
      this.listenersAdded || (this.addListeners(), this.listenersAdded = true);
    ...
    this.initHC || (d.callInitHandler(this), this.initHC = true);
    ...
    try {
      document.removeEventListener("touchstart", this.docfn1, true), document.removeEventListener("touchend", this.docfn2, true);
    } catch (b) {}
    ...
    var b = this;
    if (b.container && false !== a.enabled) {
    ...
    a = {x: a, y: b, text: c, align: e, size: d, color: f, alpha: k, rotation: h, bold: l, url: m, enabled: true};
    ...
    this.drawTitles(true);
    return this.titleHeight;
  }, addTitle: function (a, b, c, e, d) {
    isNaN(b) && (b = this.fontSize + 2);
    a = {text: a, size: b, color: c, alpha: e, bold: d, enabled: true};
    this.titles.push(a);
    return a;
  ...
  }, handleWheelReal: function () {}, handleDocTouchStart: function () {
    this.handleMouseMove();
    this.tmx = this.mouseX;
    this.tmy = this.mouseY;
    this.touchStartTime = (new Date).getTime();
  }, handleDocTouchEnd: function () {
    -0.5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy && this.tmy < this.divRealHeight ? (this.handleMouseMove(), 4 > Math.abs(this.mouseX - this.tmx) && 4 > Math.abs(this.mouseY - this.tmy) ? (this.tapped = true, this.panRequired && this.panEventsEnabled && this.chartDiv && (this.chartDiv.style.msTouchAction = "none", this.chartDiv.style.touchAction = "none")) : this.mouseIsOver || this.resetTouchStyle()) : (this.tapped = false, this.resetTouchStyle());
    ...
    if (a) if (a.touches) b.isTouchEvent = true; else if (!b.isTouchEvent) return true;
    if (c - b.touchStartTime > b.touchClickDuration) return true;
    setTimeout(function () {
    ...
    if (4 < Math.abs(this.mouseX - this.tmx) || 4 < Math.abs(this.mouseY - this.tmy)) return true;
    ...
    }, true), b.addEventListener("touchmove", function (b) {
      a.handleMouseMove.call(a, b);
    }, true), b.addEventListener("touchend", function (b) {
      a.handleTouchEnd.call(a, b);
    }, true), a.docfn1 = function (b) {
      a.handleDocTouchStart.call(a, b);
    }, a.docfn2 = function (b) {
      a.handleDocTouchEnd.call(a, b);
    }, document.addEventListener("touchstart", a.docfn1, true), document.addEventListener("touchend", a.docfn2, true)), b.addEventListener("mousedown", function (b) {
      a.mouseIsOver = true;
      a.handleMouseMove.call(a, b);
      a.handleMouseDown.call(a, b);
      a.handleDocTouchStart.call(a, b);
    }, true), b.addEventListener("mouseover", function (b) {
      a.handleMouseOver.call(a, b);
    }, true), b.addEventListener("mouseout", function (b) {
      a.handleMouseOut.call(a, b);
    }, true), b.addEventListener("mouseup", function (b) {
      a.handleDocTouchEnd.call(a, b);
    }, true)) : (b.attachEvent("onmousedown", function (b) {
      a.handleMouseDown.call(a, b);
    ...
    this.skipEvents || (this.dispatchDataUpdated && (this.dispatchDataUpdated = false, this.fire({type: "dataUpdated", chart: this})), this.chartCreated || (this.chartCreated = true, this.fire({type: "init", chart: this})), !this.chartRendered && 0 < this.divRealWidth && 0 < this.divRealHeight && (this.fire({type: "rendered", chart: this}), this.chartRendered = true), this.fire({type: "drawn", chart: this}));
    ...
    this.chartCreated && (this.dataChanged = true, this.marginsUpdated = false, this.initChart(a));
  }, validateNow: function (a, b) {
    this.initTO && clearTimeout(this.initTO);
    a && (this.dataChanged = true, this.marginsUpdated = false);
    this.skipEvents = b;
  ...
  }, cleanChart: function () {}, hideBalloonReal: function () {
    var a = this.balloon;
    a && a.hide && a.hide();
    ...
    this.handleMouseMove();
    var f = this.balloon;
    f.enabled && (f.followCursor(false), f.changeColor(b), !c || f.fixedPosition ? (f.setPosition(e, d), isNaN(e) || isNaN(d) ? f.followCursor(true) : f.followCursor(false)) : f.followCursor(true), a && f.showBalloon(a));
  ...
  }, handleKeyUp: function (a) {}, addLegend: function (a, b) {
    ...
    this.legend = a;
    a.chart = this;
    c ? (a.div = c, a.position = "outside", a.autoMargins = false) : a.div = this.legendDiv;
    return a;
    ...
    if (this.animations) for (a = this.animations.length - 1; 0 <= a; a--) {
      ...
      } else g.node.style[f] = Number(b.to) + b.suffix, g.animationFinished = true, this.animations.splice(a, 1);
    }
  }, update: function () {
    this.updateAnimations();
    var a = this.animatable;
    if (0 < a.length) {
      for (var b = true, c = a.length - 1; 0 <= c; c--) {
        var e = a[c];
        e && (e.animationFinished ? a.splice(c, 1) : b = false);
      }
    ...
    var a = this.amLink;
    if (a) {
      var b = this.creditsPosition, c = a.style, e = a.offsetWidth, a = a.offsetHeight, d = 0, f = 0, h = this.realWidth, k = this.realHeight, l = this.type;
  ...
  d.Title = d.Class({construct: function (a) {
    this.cname = "Title";
    d.applyTheme(this, a, this.cname);
  }});
  d.Label = d.Class({construct: function (a) {
    this.cname = "Label";
    d.applyTheme(this, a, this.cname);
  }});
}());
(function () {
  var d = window.AmCharts;
  d.AmGraph = d.Class({construct: function (a) {
    this.cname = "AmGraph";
    ...
    this.columnCount = 1;
    this.columnIndex = 0;
    this.centerCustomBullets = this.showBalloon = true;
    this.maxBulletSize = 50;
    this.minBulletSize = 4;
    this.balloonText = "[[value]]";
    this.hidden = this.scrollbar = this.animationPlayed = false;
    this.pointPosition = "middle";
    this.depthCount = 1;
    this.includeInMinMax = true;
    this.negativeBase = 0;
    ...
    this.noRounding = true;
    d.applyTheme(this, a, this.cname);
  }, init: function () {
    this.createBalloon();
  }, draw: function () {
    var a = this.chart;
    a.isRolledOverBullet = false;
    var b = a.type;
    if (a.drawGraphs) {
      ...
      d.ifArray(this.data) && (a = false, "xy" == b ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = true) : this.valueAxis.axisCreated && (a = true), !this.hidden && a && this.createGraph());
      e.push(c);
    }
    ...
    if ("step" == c || d.VML) a.noRounding = false;
    var c = b.type;
    "gantt" == c && (c = "serial");
    ...
    for (d = this.start; d <= this.end; d++) {
      var f = this.data[d].axes[c.id].graphs[this.id], h = f.values, k = h.x, l = h.y, h = c.getCoordinate(k, this.noRounding), m = e.getCoordinate(l, this.noRounding);
    ...
    for (m = this.start; m <= this.end; m++) {
      ...
      if (isNaN(q)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []); else {
        ...
        c.push(t);
        if (!isNaN(p)) {
          var w = this.valueAxis.getCoordinate(p, this.noRounding) - this.height, w = w * this.valueAxis.rMultiplier, z = w * Math.sin(r / 180 * Math.PI), r = w * Math.cos(r / 180 * Math.PI);
          e.push(z);
          d.push(r);
          isNaN(k) && (k = z);
          isNaN(l) && (l = r);
    ...
    if (e) {
      var f = this.chart, h = this.valueAxis, k = "middle", l = false, m = this.labelPosition, n = e.getBBox(), q = this.chart.rotate, p = a.isNegative, t = this.fontSize;
      ...
      switch (m) {
        ...
        case "left":
          ...
          break;
        case "inside":
          "column" == this.type && (l = true, q ? p ? (k = "end", b = r - 3 - z) : (k = "start", b = r + 3 + z) : c = p ? w + 7 + z : w - 10 - z);
          break;
        case "middle":
          "column" == this.type && (l = true, q ? b -= (b - r) / 2 + z - 3 : c -= (c - w) / 2 + z - 3);
      }
    ...
    var a = this.chart, b = this.id, c = this.index, e = this.data, g = this.chart.container, f = this.valueAxis, h = this.type, k = this.columnWidthReal, l = this.showBulletsAt;
    ...
    if (!(J || "line" != h && "smoothedLine" != h && "step" != h || (1 == e.length && "step" != h && "none" == this.bullet && (this.bullet = "round", this.resetBullet = true), !Ra && void 0 == Ja || m))) {
      var Ua = Pa;
      Ua > f.max && (Ua = f.max);
      Ua < f.min && (Ua = f.min);
      f.logarithmic && (Ua = f.minReal);
      var Ka = f.getCoordinate(Ua) + 0.5, Mb = f.getCoordinate(f.max);
    ...
    ia < e.length - 1 && ia++;
    var T = [], U = [], Ma = false;
    if ("line" == h || "step" == h || "smoothedLine" == h) if (this.stackable && "regular" == M || "100%" == M || this.fillToGraph) Ma = true;
    var Ob = this.noStepRisers, db = -1000, eb = -1000, ob = this.minDistance, Sa = true, Va = false;
    for (L = P; L <= ia; L++) {
      G = e[L];
      ...
      if (Ia) {
        ...
        m && (void 0 == this.openField ? fb && (fb.isNegative = Ta < W ? true : false, isNaN(Ta) && (v.isNegative = !Sa)) : v.isNegative = Ta > W ? true : false);
        ...
        if (!Bb && W < ua || Bb && W < Ba) v.isNegative = true, Ra && (Na = Ra), cb && (Wa = cb), void 0 != Ja && (Ha = Ja);
        Va = false;
        isNaN(W) || (m ? W > Ta ? (Sa && (Va = true), Sa = false) : (Sa || (Va = true), Sa = true) : v.isNegative = W < Pa ? true : false, Ba = W);
        var Pb = false;
        J && a.chartScrollbar.ignoreCustomColors && (Pb = true);
        Pb || (void 0 != v.color && (Na = v.color), v.fillColors && (Na = v.fillColors));
        F = d.fitToBounds(F, -30000, 3e4);
        switch (h) {
          case "line":
            if (isNaN(W)) z || (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = []); else {
              ...
              v.gap && (this.drawLineGraph(x, u, T, U), x = [], u = [], T = [], U = [], eb = db = -1000);
            }
            break;
          case "smoothedLine":
          ...
          case "column":
            ...
            if (!isNaN(W)) {
              m || (v.isNegative = W < Pa ? true : false);
              ...
              if (!(W < Qb && rb < Qb || W > Rb && rb > Rb)) {
                ...
                if (t) {
                  ...
                  v.labelIsNegative = 0 > ba ? true : false;
                  0 === ba && 1 / W === Infinity && (v.labelIsNegative = true);
                  ...
                  ba = F - N;
                  v.labelIsNegative = 0 < ba ? true : false;
                  0 === ba && 1 / W !== 1 / Math.abs(W) && (v.labelIsNegative = true);
                  var fc = R;
              ...
              if (va) {
                ...
                v.className && d.setCN(a, va.set, v.className, true);
                v.columnGraphics = za;
                S = d.roundTo(S, 2);
                R = d.roundTo(R, 2);
                za.translate(S, R);
            ...
            if (!isNaN(ua) && !isNaN(W)) {
              ...
              if (t) {
                ...
                if (S < n && 0 < K) {
                  ...
                  !isNaN(ta) && !isNaN(ra) && E < n && 0 < E && (Ya = d.line(g, [E, E], Gb, Ca, X, da), hb = d.line(g, [E, E], Hb, Ca, X, da), d.setCN(a, Ya, this.bcn + "line-high"), v.className && d.setCN(a, Ya, v.className, true), d.setCN(a, hb, this.bcn + "line-low"), v.className && d.setCN(a, hb, v.className, true));
                }
              }
          ...
          case "ohlc":
            if (!(isNaN(ua) || isNaN(zb) || isNaN(Ab) || isNaN(W))) {
              var Sb = g.set();
              fa.push(Sb);
              W < ua && (v.isNegative = true, void 0 != Ja && (Ha = Ja));
              ...
              if (t) {
                ...
                "high" == l && (la = ta);
                "low" == l && (la = ra);
                var ka = E, ra = d.fitToBounds(ra, 0, Fa), ta = d.fitToBounds(ta, 0, Fa), Kb = E - k / 2, Kb = d.fitToBounds(Kb, 0, n), Ub = d.fitToBounds(E, 0, n), Lb = E + k / 2, Lb = d.fitToBounds(Lb, 0, n);
              ...
              v.className && d.setCN(a, Sb, v.className, true);
    ...
    if (1 < a.length) {
      ...
      q = d.line(l, a, b, t, q, p, x, false, false, f);
      ...
      void 0 === z || g.useNegativeColorIfDown || (p = d.line(l, a, b, z, r, p, x, false, false, f), p.node.setAttribute("stroke-linejoin", "round"), d.setCN(k, p, g.bcn + "stroke"), d.setCN(k, p, g.bcn + "stroke-negative"), n.push(p));
    ...
    if (1 < a.length) {
      ...
      g.push(l);
      g.push(k);
      var m = this.lineAlpha, n = this.lineThickness, g = this.dashLength, q = this.fillAlphas, p = this.lineColorR, t = this.fillColorsR, r = this.negativeLineColor, w = this.negativeFillColors, z = this.negativeFillAlphas, x = this.baseCoord, u = this.lineColorSwitched;
      u && (p = u);
    ...
    b && (this.rotate ? (b.translate(-1000, d), c.translate(-1000, d)) : (b.translate(e, -1000), c.translate(e, -1000)), b.animate({opacity: 1, translate: e + "," + d}, f, h), c.animate({opacity: 1, translate: e + "," + d}, f, h), a.animatable.push(b));
  }, animate: function (a) {
    ...
    if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
      ...
      var k = a.values.value, l = this.maxValue, m = this.minValue, n = this.maxBulletSize, q = this.minBulletSize;
      ...
      f = this.bullet;
      a.bullet && (f = a.bullet);
      var k = this.bulletBorderThickness, m = this.bulletBorderColorR, n = this.bulletBorderAlpha, t = this.bulletAlpha;
      m || (m = q);
      ...
      if (p) {
        ...
        if ("serial" == e.type || "gantt" == e.type) if (-0.5 > b || b > this.width || c < -h / 2 || c > this.height) p.remove(), p = null;
        p && (this.bulletSet.push(p), p.translate(b, c), this.addListeners(p, a), this.allBullets.push(p));
        a.bx = b;
        a.by = c;
        d.setCN(e, p, this.bcn + "bullet");
        a.className && d.setCN(e, p, a.className, true);
      }
      if (p) {
        p.size = h || 0;
        if (e = this.bulletHitAreaSize) g = d.circle(g, e, "#FFFFFF", 0.001, 0), g.translate(b, c), a.hitBullet = g, this.bulletSet.push(g), this.addListeners(g, a);
        a.bulletGraphics = p;
    ...
    if (a) {
      var f = this.chart, h = this.balloon, k = 0, l = 0, m = f.chartCursor, n = true;
      m ? m.valueBalloonsEnabled || (h = f.balloon, k = this.x, l = this.y, n = false) : (h = f.balloon, k = this.x, l = this.y, n = false);
      ...
      if (h && h.enabled && this.showBalloon && !this.hidden) {
        var m = f.formatString(this.balloonText, a, true), q = this.balloonFunction;
        q && (m = q(a, a.graph));
        m && (m = d.cleanFromEmpty(m));
        m && "" !== m ? (e = f.getBalloonColor(this, a), h.drop || (h.pointerOrientation = b), b = a.x, g = a.y, f.rotate && (b = a.y, g = a.x), b += k, g += l, isNaN(b) || isNaN(g) ? this.hideBalloonReal() : (a = this.width, q = this.height, n && h.setBounds(k, l, a + k, q + l), h.changeColor(e), h.setPosition(b, g), h.fixPrevious(), h.fixedPosition && (c = false), !c && "radar" != f.type && (b < k - 0.5 || b > a + k || g < l - 0.5 || g > q + l) ? (h.showBalloon(m), h.hide(0)) : (h.followCursor(c), h.showBalloon(m)))) : (this.hideBalloonReal(), h.hide(), this.resizeBullet(a, e, g));
...
(function () {
  var d = window.AmCharts;
  d.ChartCursor = d.Class({construct: function (a) {
    ...
    this.categoryBalloonEnabled = this.valueBalloonsEnabled = true;
    this.rolledOver = false;
    this.cursorPosition = "middle";
    this.bulletsEnabled = this.skipZoomDispatch = false;
    this.bulletSize = 8;
    this.selectWithoutZooming = this.oneBalloonOnly = false;
    this.graphBulletSize = 1.7;
    this.animationDuration = 0.3;
    this.zooming = false;
    this.adjustment = 0;
    this.avoidBalloonOverlapping = true;
    this.leaveCursor = false;
    this.leaveAfterTouch = true;
    this.valueZoomable = false;
    this.balloonPointerOrientation = "horizontal";
    this.hLineEnabled = this.vLineEnabled = true;
    this.vZoomEnabled = this.hZoomEnabled = false;
    d.applyTheme(this, a, this.cname);
  }, draw: function () {
    this.destroy();
    var a = this.chart;
    ...
    a.cursorSet.push(b);
    this.createElements();
    d.isString(this.limitToGraph) && (this.limitToGraph = d.getObjById(a.graphs, this.limitToGraph), this.fullWidth = false, this.cursorPosition = "middle");
    ...
    if (a) {
      ...
      if (a.chartData && 0 < a.chartData.length) {
        this.mouseIsOver() ? (this.hideGraphBalloons = false, this.rolledOver = e = true, this.updateDrawing(), this.vvLine && isNaN(this.fx) && (a.rotate || !this.limitToGraph) && this.vvLine.translate(b, 0), !this.hhLine || !isNaN(this.fy) || a.rotate && this.limitToGraph || this.hhLine.translate(0, c), isNaN(this.mouse2X) ? this.dispatchMovedEvent(b, c) : e = false) : this.forceShow || this.hideCursor();
        if (this.zooming) {
    ...
    !this.drawing && this.enabled && (this.vLineEnabled && this.vvLine && this.vvLine.show(), this.hLineEnabled && this.hhLine && this.hhLine.show(), this.isHidden = false, this.updateFullLine(), a || this.fire({target: this, chart: this.chart, type: "onShowCursor"}), this.pan && this.chart.setMouseCursor("move"));
    ...
    var a = this.mouseX, b = this.mouseY;
    if (this.justReleased) return this.justReleased = false, true;
    if (this.mouseIsDown) return true;
    if (!this.chart.mouseIsOver) return this.handleMouseOut(), false;
    if (0 < a && a < this.width && 0 < b && b < this.height) return true;
    this.handleMouseOut();
    return false;
    ...
    this.update();
    if (this.mouseIsOver()) if (this.mouseIsDown = true, this.mouseX0 = this.mouseX, this.mouseY0 = this.mouseY, this.mouse2X0 = this.mouse2X, this.mouse2Y0 = this.mouse2Y, this.drawing) this.drawStartY = this.mouseY, this.drawStartX = this.mouseX, this.drawingNow = true; else if (this.dispatchMovedEvent(this.mouseX, this.mouseY), !this.pan && isNaN(this.mouse2X0) && (isNaN(this.fx) || (this.mouseX0 = this.fx), isNaN(this.fy) || (this.mouseY0 = this.fy)), this.hZoomEnabled || this.vZoomEnabled) {
      this.zooming = true;
  ...
  }, registerInitialMouse: function () {}, handleReleaseOutside: function () {
    ...
    this.zooming && (this.zooming = false, this.selectWithoutZooming ? this.dispatchZoomEvent("selected") : (this.hZoomEnabled || this.vZoomEnabled) && this.dispatchZoomEvent("zoomed"), this.rolledOver && this.dispatchMovedEvent(this.mouseX, this.mouseY));
    ...
    if (!this.pan) {
      ...
      if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
        var c = Math.min(this.index, this.index0), e = Math.max(this.index, this.index0), d = c, f = e, h = this.chart, k = h.chartData, l = h.categoryAxis;
        ...
        this.hZoomEnabled && 4 < Math.abs(this.mouseX0 - this.mouseX) && (b.startX = this.mouseX0 / this.width, b.endX = this.mouseX / this.width, m = true);
        this.vZoomEnabled && 4 < Math.abs(this.mouseY0 - this.mouseY) && (b.startY = 1 - this.mouseY0 / this.height, b.endY = 1 - this.mouseY / this.height, m = true);
    ...
    if (this.mouseIsDown) {
      var a = d.roundTo((this.mouseX - this.mouseX0) / this.width, 3), b = d.roundTo((this.mouseY - this.mouseY0) / this.height, 3), c = d.roundTo((this.mouse2X - this.mouse2X0) / this.width, 3), e = d.roundTo((this.mouse2Y - this.mouse2Y0) / this.height, 2), g = false;
      0 !== Math.abs(a) && 0 !== Math.abs(b) && (g = true);
      if (this.prevDeltaX == a || this.prevDeltaY == b) g = false;
      isNaN(c) || isNaN(e) || (0 !== Math.abs(c) && 0 !== Math.abs(e) && (g = true), this.prevDelta2X != c && this.prevDelta2Y != e) || (g = false);
    ...
    d.remove(this.set);
  }, clear: function () {}, setTimestamp: function (a) {
    this.timestamp = a;
  }, setIndex: function (a, b) {
    a != this.index && (this.index = a, b || this.isHidden || this.dispatchMovedEvent(this.mouseX, this.mouseY, "changed"));
  }, handleMouseOut: function () {
    this.enabled && this.rolledOver && (this.leaveCursor || this.setIndex(void 0), this.forceShow = false, this.hideCursor(), this.rolledOver = false);
    ...
    if (e) {
      ...
      this.updateFullLine();
      this.isHidden = false;
      this.dispatchMovedEvent(f, d, "moved", true);
    }
    ...
    clearTimeout(this.syncTO);
    a && (a.isHidden ? this.hideCursor(true) : this.syncWithCursorReal(a, b));
    ...
    this.index = a.index;
    this.forceShow = true;
    this.zooming && this.pan || this.showCursor(true);
    ...
    this.dispatchMovedEvent(d, f, "moved", true);
  }});
}());
(function () {
  var d = window.AmCharts;
  d.SimpleChartScrollbar = d.Class({construct: function (a) {
    ...
    this.hideResizeGrips = false;
    this.scrollbarHeight = 20;
    this.updateOnReleaseOnly = false;
    9 > document.documentMode && (this.updateOnReleaseOnly = true);
    ...
    if (a.enabled) {
      ...
      if ((a.height = h) && f) {
        ...
        var q = d.rect(b, m, n, "#000", 0.005), p = d.rect(b, m, n, "#000", 0.005);
    ...
    isNaN(d) || isNaN(e) || this.percentZoom(e, d, true);
    ...
    var a, b = false, c, e, d = this.x, f = this.y, h = this.dragger, k = this.getDBox();
    if (k) {
      c = k.x + d;
      e = k.y + f;
      var l = k.width, k = k.height, m = this.rotate, n = this.chart, q = this.width, p = this.height, t = n.mouseX, n = n.mouseY;
      a = this.initialMouse;
      this.forceClip && this.clipDragger(true);
      if (this.dragging) {
        ...
        this.clipDragger(true);
      }
      if (this.resizingRight) {
        if (m) if (a = n - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight), a + e > p + f && (a = p - e + f), 0 > a) this.resizingRight = false, b = this.resizingLeft = true; else {
          if (0 === a || isNaN(a)) a = 0.1;
          h.setAttr("height", a);
        } else if (a = t - c, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth), a + c > q + d && (a = q - c + d), 0 > a) this.resizingRight = false, b = this.resizingLeft = true; else {
          if (0 === a || isNaN(a)) a = 0.1;
          h.setAttr("width", a);
        }
        this.clipDragger(true);
      ...
      if (this.resizingLeft) {
        if (m) if (c = e, e = n, e < f && (e = f), isNaN(e) && (e = f), e > p + f && (e = p + f), a = true === b ? c - e : k + c - e, !isNaN(this.maxHeight) && a > this.maxHeight && (a = this.maxHeight, e = c), 0 > a) this.resizingRight = true, this.resizingLeft = false, h.setAttr("y", c + k - f); else {
          if (0 === a || isNaN(a)) a = 0.1;
          h.setAttr("y", e - f);
          h.setAttr("height", a);
        } else if (e = t, e < d && (e = d), isNaN(e) && (e = d), e > q + d && (e = q + d), a = true === b ? c - e : l + c - e, !isNaN(this.maxWidth) && a > this.maxWidth && (a = this.maxWidth, e = c), 0 > a) this.resizingRight = true, this.resizingLeft = false, h.setAttr("x", c + l - d); else {
          if (0 === a || isNaN(a)) a = 0.1;
          h.setAttr("x", e - d);
          h.setAttr("width", a);
        }
    ...
    this.animating = this.forceClip = false;
  }, clipDragger: function (a) {
    var b = this.getDBox();
    if (b) {
      var c = b.x, e = b.y, d = b.width, b = b.height, f = false;
      if (this.rotate) {
        if (c = 0, d = this.width + 1, this.clipY != e || this.clipH != b) f = true;
      } else if (e = 0, b = this.height + 1, this.clipX != c || this.clipW != d) f = true;
      f && this.clipAndUpdate(c, e, d, b);
      a && (this.updateOnReleaseOnly || this.dispatchScrollbarEvent());
    }
  }, maskGraphs: function () {}, clipAndUpdate: function (a, b, c, e) {
    this.clipX = a;
    this.clipY = b;
    this.clipW = c;
    this.clipH = e;
    ...
    if (this.skipEvent) this.skipEvent = false; else {
      var a = this.chart;
      a.hideBalloon();
      var b = this.getDBox(), c = b.x, e = b.y, d = b.width, b = b.height;
      this.getPercents();
      this.rotate ? (c = e, d = this.height / b) : d = this.width / d;
      a = {type: "zoomed", position: c, chart: a, target: this, multiplier: d, relativeStart: this.percentStart, relativeEnd: this.percentEnd};
    ...
    var a = this.getDBox(), b = a.x, c = a.y, e = this.iconLeft, d = this.iconRight, f, h, k = this.scrollbarHeight;
  ...
  }, clear: function () {}, handleDragStart: function () {
    if (this.enabled) {
    ...
    this.updateOnReleaseOnly && (this.update(), this.skipEvent = false, this.dispatchScrollbarEvent());
    this.dragging = false;
    ...
    this.resizingLeft && (this.resizingLeft = false, this.mouseIsOver || this.removeCursors(), this.updateOnRelease(), this.fireZoomEvent("zoomEnded"));
    this.updateGripCursor(false);
    ...
    this.resizingRight && (this.resizingRight = false, this.mouseIsOver || this.removeCursors(), this.updateOnRelease(), this.fireZoomEvent("zoomEnded"));
    this.updateGripCursor(false);
    ...
    if (!a.resizingRight && !a.resizingLeft) {
      ...
      a.updateOnReleaseOnly ? (a.skipEvent = false, g.setAttr(b, c), a.dispatchScrollbarEvent(), a.clipDragger()) : (a.animating = true, c = Math.round(c), m ? g.animate({y: c}, e, ">") : g.animate({x: c}, e, ">"), a.forceClip = true, clearTimeout(a.forceTO), a.forceTO = setTimeout(function () {
    ...
    if (this.set) {
      if (this.resizingLeft || this.resizingRight || this.dragging) this.dragging = this.resizingRight = this.resizingLeft = false, this.updateOnRelease(), this.removeCursors();
      this.animating = this.mouseIsOver = false;
      this.hideDragIcons();
      this.update();
    }
  }, handleMouseOver: function () {
...
(function () {
  var d = window.AmCharts;
  d.ChartScrollbar = d.Class({inherits: d.SimpleChartScrollbar, construct: function (a) {
    ...
    this.gridAlpha = 0.7;
    this.skipEvent = this.autoGridCount = false;
    this.color = "#FFFFFF";
    this.scrollbarCreated = false;
    this.oppositeAxis = true;
    this.accessibleLabel = "Zoom chart using cursor arrows";
    d.applyTheme(this, a, this.cname);
  }, init: function () {
    var a = this.categoryAxis, b = this.chart, c = this.gridAxis;
    a || ("CategoryAxis" == this.gridAxis.cname ? (this.catScrollbar = true, a = new d.CategoryAxis, a.id = "scrollbar") : (a = new d.ValueAxis, a.data = b.chartData, a.id = c.id, a.type = c.type, a.maximumDate = c.maximumDate, a.minimumDate = c.minimumDate, a.minPeriod = c.minPeriod, a.minMaxField = c.minMaxField), this.categoryAxis = a);
    a.chart = b;
    ...
    (a = this.graph) && this.catScrollbar && (c = this.valueAxis, c || (this.valueAxis = c = new d.ValueAxis, c.visible = false, c.scrollbar = true, c.axisItemRenderer = d.RecItem, c.axisRenderer = d.RecAxis, c.guideFillRenderer = d.RecFill, c.labelsEnabled = false, c.chart = b), b = this.unselectedGraph, b || (b = new d.AmGraph, b.scrollbar = true, this.unselectedGraph = b, b.negativeBase = a.negativeBase, b.noStepRisers = a.noStepRisers), b = this.selectedGraph, b || (b = new d.AmGraph, b.scrollbar = true, this.selectedGraph = b, b.negativeBase = a.negativeBase, b.noStepRisers = a.noStepRisers));
    ...
    if (a.enabled) {
      ...
      var b = a.chart, c = b.chartData, e = a.categoryAxis, g = a.rotate, f = a.x, h = a.y, k = a.width, l = a.height, m = a.gridAxis, n = a.set;
      e.setOrientation(!g);
    ...
    if (this.categoryAxis && "ValueAxis" == this.categoryAxis.cname) d.ChartScrollbar.base.dispatchScrollbarEvent.call(this); else if (this.skipEvent) this.skipEvent = false; else {
      ...
      f.chart = h;
      var k = this.categoryAxis, l = this.stepWidth, e = h.minSelectedTime, m = h.maxSelectedTime, g = false;
      if (k.parseDates && !k.equalSpacing) {
        if (a = h.lastTime, h = h.firstTime, k = Math.round(b / l) + h, b = this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + h, k > b && (k = b), 0 < e && b - k < e && (b = Math.round(k + (b - k) / 2), g = Math.round(e / 2), k = b - g, b += g, g = true), 0 < m && b - k > m && (b = Math.round(k + (b - k) / 2), g = Math.round(m / 2), k = b - g, b += g, g = true), b > a && (b = a), b - e < k && (k = b - e), k < h && (k = h), k + e > b && (b = k + e), k != this.startTime || b != this.endTime) this.startTime = k, this.endTime = b, f.start = k, f.end = b, f.startDate = new Date(k), f.endDate = new Date(b), this.fire(f);
      } else {
        m = l / 2;
...
(function () {
  var d = window.AmCharts;
  d.AmBalloon = d.Class({construct: function (a) {
    ...
    this.color = "#000000";
    this.adjustBorderColor = true;
    this.show = this.follow = this.showBullet = false;
    this.bulletSize = 3;
    ...
    if (!isNaN(a)) {
      ...
      if (this.show) {
        var h = this.l, k = this.t, l = this.r, m = this.b, n = this.balloonColor, q = this.fillColor, p = this.borderColor, t = q;
        ...
        !isNaN(D) && C < D && (C = D);
        window.opera && (A += 2);
        var Q = false, y = this.offsetY;
        c.handDrawn && (y += c.handDrawScatter + 2);
        "H" != x ? (D = a - C / 2, b < k + A + 10 && "down" != x ? (Q = true, e && (b += y), y = b + z, this.deltaSignY = -1) : (e && (b -= y), y = b - A - z, this.deltaSignY = 1)) : (2 * z > A && (z = A / 2), y = b - A / 2, a < h + (l - h) / 2 ? (D = a + z, this.deltaSignX = -1) : (D = a - C - z, this.deltaSignX = 1));
        y + A >= m && (y = m - A);
        y < k && (y = k);
        D < h && (D = h);
        D + C > l && (D = l - C);
        ...
        B.left = m + "px";
        B.top = k + "px";
        f.translate(D - g, y, 1, true);
        q = q.getBBox();
        this.bottom = y + A + 1;
        this.yPos = q.y + y;
        J && J.translate(this.pointToX - D + g, b - y);
        b = this.animationDuration;
        0 < this.animationDuration && !e && !isNaN(this.prevX) && (f.translate(this.prevX, this.prevY, NaN, true), f.animate({translate: D - g + "," + y}, b, "easeOutSine"), n && (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim = c.animate({node: n}, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim = c.animate({node: n}, "top", this.prevTY, k, b, "easeOutSine", "px")));
        this.prevX = D - g;
        this.prevY = y;
        this.prevTX = m;
        this.prevTY = k;
    ...
    if (this.text != a || this.positionChanged) this.text = a, this.isHiding = false, this.show = true, this.destroyTO && clearTimeout(this.destroyTO), a = this.chart, this.fadeAnim1 && a.stopAnim(this.fadeAnim1), this.fadeAnim2 && a.stopAnim(this.fadeAnim2), this.draw(), this.positionChanged = false;
  }, hide: function (a) {
    var b = this;
    b.text = void 0;
    ...
    } else b.show = false, b.follow = false, b.destroy();
  }, setPosition: function (a, b) {
    if (a != this.pointToX || b != this.pointToY) this.previousX = this.pointToX, this.previousY = this.pointToY, this.pointToX = a, this.pointToY = b, this.positionChanged = true;
...
(function () {
  var d = window.AmCharts;
  d.AmCoordinateChart = d.Class({inherits: d.AmChart, construct: function (a) {
    ...
    var k = false, l, m = this.categoryAxis, n, q, p;
      ...
      for (I = 0; I < C.length; I++) {
        ...
        for (Q = 0; Q < g.length; Q++) {
          ...
          if (b.valueAxis.id == H) {
            ...
            if (!b.connect || b.forceGap && !isNaN(b.gapPeriod)) if (y && y[M] && 0 < P && B.time - w[M] >= z * P && (y[M].gap = true), b.forceGap) {
              var P = 0, ma;
    ...
    var e = {}, g, f = false;
    "candlestick" != b.type && "ohlc" != b.type || "" === c || (f = true);
    ...
    this.validateData();
  }, handleValueAxisZoom: function () {}, processValueAxes: function () {
    var a = this.valueAxes, b;
    for (b = 0; b < a.length; b++) {
    ...
    a.switchable && (a.hidden = false, this.dataChanged = true, "xy" != this.type && (this.marginsUpdated = false), this.chartCreated && this.initChart());
  }, hideGraph: function (a) {
    a.switchable && (this.dataChanged = true, "xy" != this.type && (this.marginsUpdated = false), a.hidden = true, this.chartCreated && this.initChart());
    ...
    if (a) {
      var b;
      for (b = 0; b < a.length; b++) a[b].animationPlayed = false;
    }
...
(function () {
  var d = window.AmCharts;
  d.TrendLine = d.Class({construct: function (a) {
    ...
    this.balloonText && (clearTimeout(this.chart.hoverInt), a = this.line.getBBox(), this.chart.showBalloon(this.balloonText, this.lineColor, true, this.x + a.x + a.width / 2, this.y + a.y + a.height / 2));
...
(function () {
  var d = window.AmCharts;
  d.Image = d.Class({construct: function (a) {
    this.cname = "Image";
    ...
    c && (c.setAttr("opacity", a.opacity), a.set.rotate(a.rotation), c.translate(-a.width / 2, -a.height / 2, d), a.balloonText && c.mouseover(function () {
      a.chart.showBalloon(a.balloonText, a.balloonColor, true);
    }).mouseout(function () {
      a.chart.hideBalloon();
    }).touchend(function () {
      a.chart.hideBalloon();
...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    isNaN(k) && (k = g);
    var q = e, p = false;
    "object" == typeof q && 1 < q.length && (p = true, q = q[0]);
    void 0 === h && (h = q);
  ...
  d.bullet = function (a, b, c, e, g, f, h, k, l, m, n, q, p) {
    ...
    switch (b) {
      ...
      case "triangleRight":
        ...
        break;
      case "bubble":
        t = d.circle(a, c / 2, e, g, f, h, k, true);
        break;
      case "line":
  ...
  d.line = function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    if (d.VML) return a.path(h, void 0, true).attr(f);
    l && (h += " M0,0 L0,0");
    return a.path(h).attr(f);
  };
  d.makeHD = function (a, b, c) {
    for (var d = [], g = [], f = 1; f < a.length; f++) for (var h = Number(a[f - 1]), k = Number(b[f - 1]), l = Number(a[f]), m = Number(b[f]), n = Math.round(Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)) / 50) + 1, l = (l - h) / n, m = (m - k) / n, q = 0; q <= n; q++) {
  ...
  d.handDrawnLine = function (a, b, c, e, g, f, h, k, l, m) {
    var n, q = a.set();
    for (n = 1; n < b.length; n++) for (var p = [b[n - 1], b[n]], t = [c[n - 1], c[n]], t = d.makeHD(p, t, a.handDrawScatter), p = t[0], t = t[1], r = 1; r < p.length; r++) q.push(d.line(a, [p[r - 1], p[r]], [t[r - 1], t[r]], e, g, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, h, k, l, m, true));
    return q;
  };
  ...
  d.drop = function (a, b, c, d, g, f, h, k) {
    var l = 0.005555555555555556 * Math.PI, m = c - 20, n = Math.sin(m * l) * b, q = Math.cos(m * l) * b, p = Math.sin((m + 40) * l) * b, t = Math.cos((m + 40) * l) * b, r = 0.8 * b, w = -b / 3, z = b / 3;
    0 === c && (w = -w, z = 0);
    180 == c && (z = 0);
    90 == c && (w = 0);
    270 == c && (w = 0, z = -z);
  ...
  d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
    ...
    359.94 < x && (x = 359.94);
    g >= x && (g = x);
    var u = 0.005555555555555556 * Math.PI, x = b + Math.sin(e * u) * k, A = c - Math.cos(e * u) * w, y = b + Math.sin(e * u) * f, B = c - Math.cos(e * u) * h, D = b + Math.sin((e + g) * u) * f, C = c - Math.cos((e + g) * u) * h, I = b + Math.sin((e + g) * u) * k, u = c - Math.cos((e + g) * u) * w, H = {fill: d.adjustLuminosity(m.fill, -0.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"]}, Q = 0;
    180 < Math.abs(g) && (Q = 1);
    e = a.set();
    var M;
    z && (x = r(10 * x), y = r(10 * y), D = r(10 * D), I = r(10 * I), A = r(10 * A), B = r(10 * B), C = r(10 * C), u = r(10 * u), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, h *= 10, k *= 10, w *= 10, 1 > Math.abs(g) && 1 >= Math.abs(D - y) && 1 >= Math.abs(C - B) && (M = true));
    g = "";
    var P;
...
(function () {
  var d = window.AmCharts;
  d.Bezier = d.Class({construct: function (a, b, c, e, g, f, h, k, l, m, n) {
    ...
    var r, w;
    "object" == typeof h && 1 < h.length && (w = true, r = h, h = h[0]);
...
(function () {
  var d = window.AmCharts;
  d.AmDObject = d.Class({construct: function (a, b) {
    this.D = b;
    this.R = b.R;
    ...
    this.node.addEventListener ? this.node.addEventListener("contextmenu", a, true) : this.R.addListener(this, "contextmenu", a);
    return this;
  }, stop: function () {
...
(function () {
  var d = window.AmCharts;
  d.VMLRenderer = d.Class({construct: function (a, b) {
    this.chart = b;
    this.D = a;
    ...
    if (void 0 !== c) {
      var e;
      8 === document.documentMode && (e = true);
      ...
      if ("shape" == f) {
        ...
        if ("fill-opacity" == b || "opacity" == b) 0 === c ? e ? a.on = false : a.setAttribute("on", false) : e ? a.opacity = c : a.setAttribute("opacity", c);
    ...
    for (g = 0; g < b.length; g++) {
      ...
      if ("Q" == h) {
        ...
        c = d(c[m - 2] / 3 + 0.6666666666666666 * q);
        n = d(n / 3 + 0.6666666666666666 * p);
        q = d(0.6666666666666666 * q + l / 3);
        p = d(0.6666666666666666 * p + t / 3);
        a += " c " + c + "," + n + "," + q + "," + p + "," + l + "," + t;
      }
    ...
    if (0 !== Number(b)) {
      ...
      a.paddingLeft = 1;
      c = b * Math.PI / 180;
      var g = Math.cos(c), f = Math.sin(c), h = d.removePx(a.left), k = d.removePx(a.top), l = e.offsetWidth, e = e.offsetHeight;
      b /= Math.abs(b);
...
(function () {
  var d = window.AmCharts;
  d.SVGRenderer = d.Class({construct: function (a) {
    this.D = a;
    this.animations = [];
  }, create: function (a, b) {
    ...
    for (a = b.length - 1; 0 <= a; a--) {
      ...
      if (g <= e) {
        ...
        this.setAttr(f, h, c);
      } else "translate" == h ? (l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), f.translate(m, l)) : (k = Number(c.to), this.setAttr(f, h, k)), f.animationFinished = true, this.animations.splice(a, 1);
    }
  }, getBBox: function (a) {
    if (a = a.node) try {
      return a.getBBox();
...
(function () {
  var d = window.AmCharts;
  d.AmLegend = d.Class({construct: function (a) {
    this.enabled = true;
    this.cname = "AmLegend";
    ...
    this.textClickEnabled = false;
    this.equalWidths = true;
    this.backgroundColor = "#FFFFFF";
    this.backgroundAlpha = 0;
    this.useGraphSettings = false;
    ...
    this.titleWidth = 0;
    if (g = this.title) g = d.text(this.container, g, this.color, a.fontFamily, this.fontSize, "start", true), d.setCN(a, g, "legend-title"), g.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = g.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
    ...
    var a = this.position, b = this.marginLeft + this.titleWidth, c = this.marginRight, e = this.marginTop, g = this.marginBottom, f = this.horizontalGap, h = this.div, k = this.divWidth, l = this.maxColumnsReal, m = this.verticalGap, n = this.spacing, q = k - c - b, p = 0, t = 0, r = this.container;
    ...
    if (false !== a.visibleInLegend && !a.hideFromLegend) {
      ...
      var k;
      true === a.hidden && (k = f = b.markerDisabledColor);
      ...
      d.setCN(c, q, a.className, true);
      k = b.switchType;
      var x;
      k && "none" != k && 0 < p && ("x" == k ? (x = b.createX(), x.translate(p / 2, p / 2)) : x = b.createV(), x.dItem = a, true !== a.hidden ? "x" == k ? x.hide() : x.show() : "x" != k && x.hide(), b.switchable || x.hide(), b.addListeners(x, a), a.legendSwitch = x, q.push(x), d.setCN(c, x, "legend-switch"));
      k = b.color;
      a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (k = b.selectedColor);
      b.useMarkerColorForLabels && !l && (k = f);
      true === a.hidden && (k = b.markerDisabledColor);
      ...
      var u;
      f && (f = d.fixBrakes(f), a.legendTextReal = f, u = b.labelWidth, u = isNaN(u) ? d.text(b.container, f, k, c.fontFamily, l, "start") : d.wrappedText(b.container, f, k, c.fontFamily, l, "start", false, u, 0), d.setCN(c, u, "legend-label"), u.translate(b.lx + t, b.ly), q.push(u), b.labelDx = t, c = u.getBBox().width, b.maxLabelWidth < c && (b.maxLabelWidth = c));
      b.entries[b.index] = q;
    ...
    this.switchable && (true === a.hidden ? this.dispatch("showItem", a, b) : this.dispatch("hideItem", a, b));
    ...
    this.textClickEnabled ? a.hidden || this.dispatch("clickLabel", a, b) : this.switchable && (true === a.hidden ? this.dispatch("showItem", a, b) : this.dispatch("hideItem", a, b));
    ...
    if (false !== a.visibleInLegend && !a.hideFromLegend) {
      ...
      if (b.valueText && 0 < b.valueWidth) {
        ...
        true === a.hidden && (l = b.markerDisabledColor);
      ...
      b.index++;
      e = b.container.rect(a.legendEntryWidth, 0, h, k, 0, 0).attr({stroke: "none", fill: "#fff", "fill-opacity": 0.005});
      e.dItem = a;
    ...
    var a = (this.markerSize - 4) / 2, b = {stroke: this.switchColor, "stroke-width": 3}, c = this.container, e = d.line(c, [-a, a], [-a, a]).attr(b), a = d.line(c, [-a, a], [a, -a]).attr(b);
...
(function () {
  ...
  d.stringToDate = function (a, b) {
    var c = {}, e = [{pattern: "YYYY", period: "year"}, {pattern: "YY", period: "year"}, {pattern: "MM", period: "month"}, {pattern: "M", period: "month"}, {pattern: "DD", period: "date"}, {pattern: "D", period: "date"}, {pattern: "JJ", period: "hours"}, {pattern: "J", period: "hours"}, {pattern: "HH", period: "hours"}, {pattern: "H", period: "hours"}, {pattern: "KK", period: "hours"}, {pattern: "K", period: "hours"}, {pattern: "LL", period: "hours"}, {pattern: "L", period: "hours"}, {pattern: "NN", period: "minutes"}, {pattern: "N", period: "minutes"}, {pattern: "SS", period: "seconds"}, {pattern: "S", period: "seconds"}, {pattern: "QQQ", period: "milliseconds"}, {pattern: "QQ", period: "milliseconds"}, {pattern: "Q", period: "milliseconds"}], g = true, f = b.indexOf("AA");
    -1 != f && (a.substr(f, 2), "pm" == a.toLowerCase && (g = false));
    var f = b, h, k, l;
