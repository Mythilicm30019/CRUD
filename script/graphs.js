...
------------------------------------------------------------------------------------------------------
 ...
 - Windows XP: IE 8, Opera 9, Firefox 3, Chrome 3
...
//----------------------------------------------------------------------------------------------------
  ...
  this.legendAlign = 'top';                  // legend vertical align: "top", "center", "bottom"
...
//----------------------------------------------------------------------------------------------------
  ...
  this.create = function() {
    ...
    if(this.legend && this.type != 'pbar' && this.type != 'fader')
      graph += '<table border=0 cellspacing=0 cellpadding=0><tr><td valign=bottom>';

    var sum = max = max_neg = max_dec = ccnt = lcnt = chart = divide = 0;
    val[chart] = new Array();
    ...
    for(chart = lcnt = 0; chart < val.length; chart++) {
      ...
      if(chart < this.charts - 1 && val[chart+1]) {
        graph += '<\/td>';
